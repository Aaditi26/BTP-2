...
function getApiBaseUrl() {
    const configured = window.OPTIMIZER_API_BASE;
    if (configured) {
...
if (window.location.protocol === "file:") {
    statusPill.textContent = "Local file mode";
    operationResults.innerHTML = `
        <p class="placeholder-text">
            This page is opened directly from disk. Start the backend with <strong>python serve.py</strong>.
            The form will send requests to <strong>http://127.0.0.1:8000</strong>.
        </p>
    `;
}
